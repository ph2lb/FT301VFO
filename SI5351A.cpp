...
//
void SI5351A::setupPLL(uint8_t pll, uint8_t mult, uint32_t num, uint32_t denom)
{
...
//
void SI5351A::setupMultisynth(uint8_t synth, uint32_t divider, uint8_t rDiv)
{
...
//
void SI5351A::CLK0OutputOff(uint8_t clk)
{
...
//
void SI5351A::CLK0SetFrequency(uint32_t frequency)
{
	uint32_t pllFreq;
